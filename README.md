...
* 
  for build this i use :-
HTML, CSS, JavaScript, Leaflet.js and OpenStreetMap.

note:-
This project currently stores data in the browser using localStorage, so it is mainly a working frontend prototype.
